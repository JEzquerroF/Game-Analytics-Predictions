...
The average playtime of the players in the current sample is slightly above 60 minutes (𝑥=60.05). However, the observed difference from the hypothesized value of 60 minutes is not statistically significant at the 95% confidence level (p-value > 0.05).
